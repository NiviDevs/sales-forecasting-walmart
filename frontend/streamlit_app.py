...
# =========================================================
# PATH SETUP (RELATIVE & DEPLOYMENT SAFE)
# =========================================================
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, ".."))

DATA_PATH = os.path.join(PROJECT_ROOT, "data", "store_history.csv")
MODEL_PATH = os.path.join(PROJECT_ROOT, "frontend", "model", "Walmart_demand_model.pkl")
...
predicted_sales = calculate_sales(
